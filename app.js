...
var cmd = require('../../libs/kodicmd');
var guicmd = require('../../libs/kodiguicmd');
...
function init () {
  ...
  Homey.manager('flow').on('action.SetCommand.KODICommand.autocomplete', function (callback, value) {
    ...
    var items = searchItems(commandSearchString, cmd.KODIcommands);
    callback(null, items);
	});
  Homey.manager('flow').on('action.SetCommand', function (callback, args) { 
   ...
   Homey.manager('flow').on('action.GUIWinCommand.KODICommand.autocomplete', function (callback, value) {
    var commandSearchString = value.query;
    var items = searchItems(commandSearchString, guicmd.GUIWinarray);
    callback(null, items);
	});
