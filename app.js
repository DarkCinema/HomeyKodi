...
function init () {
  ...
  Homey.manager('flow').on('action.SetCommand', function (callback, args) { 
   ...
   Homey.manager('flow').on('action.GUIWinCommand.KODICommand.autocomplete', function (callback, value) {
    var commandSearchString = value.query;
    var items = searchItems(commandSearchString, GUIWinarray);
    callback(null, items);
	});
  Homey.manager('flow').on('action.GUIWinCommand', function (callback, args) { 
    onFlowActionKODICommand (callback, args);
    callback(null, true);
  });
}
...
function onFlowActionSendNotification (callback, args) {
  Homey.log('onFlowActionSendNotification()', args)
